<template>
  <header class="bg-light row mb-4 py-4">
    <div class="container m-auto d-flex flex-wrap items-center justify-content-between">
      <div class="items-center">
        ...
        <a href="/" class="uppercase small pl-4">Record Store</a>
      </div>
      <div>
